...
% ProfSel is a cell of strings of profile names selected to be fitted.
ProfSel  = {'WT','B4galt1','St3gal3','St3gal4','St3gal6','B3gnt2','Mgat2'}; 
...
for a = 1:length(ProfSel)
    ...
    for k = 1:num
        ...
        if StericFlag && ~strcmp(ProfSel{a},'WT')
