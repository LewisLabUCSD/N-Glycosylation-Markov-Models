...
ProfSel  = {'St3gal6','B4galt1','WT'}; % a cell of strings of profile names selected to be fitted.
...
save('Data/OptimizationResults/OptimizationResults_others_test_2.mat','OptimizationResults');