...
ProfSel  = {'Mgat2'}; % a cell of strings of profile names selected to be fitted.
...
save('Data/OptimizationResults/OptimizationResults_others_52.mat','OptimizationResults');