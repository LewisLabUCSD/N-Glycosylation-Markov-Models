function OptimizationResults = RecordOptimizationResults_PSO(Prof, OptimizationResults, xval, fval,OptimizationProblem)
...
if OptimizationProblem.StericFlag
   xval_full = zeros(1, length(AppliedGeneidx));
    ...
    xval_full = zeros(1, OptimizationProblem.optimproblem.nvars+3);
end
