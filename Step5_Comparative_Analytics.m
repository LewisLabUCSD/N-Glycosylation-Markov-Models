...
for a = 1:length(ProfSel)
    ...
    %% Step 4b. visualize fitted transition probabilities (optional)
    ...
    %% Step 4c. visualize fitted glycoprofiles (optional)
    ...
    %% Step 4e. visualize model pseudo-fluxes of fitted glycoprofiles (optional)
    % [plotData,plotErr] = PlotPredVsExp(ProfSel{a},OptimizationResults);
